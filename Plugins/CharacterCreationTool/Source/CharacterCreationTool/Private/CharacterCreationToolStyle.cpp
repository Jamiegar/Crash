...
{
	static FName StyleSetName(TEXT("CharacterCreationToolStyle"));
	return StyleSetName;
}
...
{
	TSharedRef< FSlateStyleSet > Style = MakeShareable(new FSlateStyleSet("CharacterCreationToolStyle"));
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("CharacterCreationTool")->GetBaseDir() / TEXT("Resources"));
